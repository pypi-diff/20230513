# Comparing `tmp/ntheory-0.0.6.tar.gz` & `tmp/ntheory-0.0.7.tar.gz`
...
## Comparing `ntheory-0.0.6.tar` & `ntheory-0.0.7.tar`
...
### Comparing `ntheory-0.0.6/LICENSE` & `ntheory-0.0.7/LICENSE`

 * *Files identical despite different names*

### Comparing `ntheory-0.0.6/PKG-INFO` & `ntheory-0.0.7/PKG-INFO`
...
### Comparing `ntheory-0.0.6/ntheory.egg-info/PKG-INFO` & `ntheory-0.0.7/ntheory.egg-info/PKG-INFO`
...
### Comparing `ntheory-0.0.6/pyproject.toml` & `ntheory-0.0.7/pyproject.toml`
